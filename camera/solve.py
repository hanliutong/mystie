...
if __name__=='__main__':
	n = {
	    ...
	    "O" : ["G", "B", "Y", "O", "O", "O", "R", "R", "B"],
	    "R" : ["R", "W", "O", "R", "R", "Y", "G", "O", "O"],
	    "ans" : [17,25,0,5,4,50,24,39,38,20,34,6,7,13,43,36,30,42,51,41,11,21,22,23,33,32,44,35,3,26,28,31,14,53,19,18,15,16,9,10,40,48,27,46,47,45,12,8,1,49,52,2,37,29]
	}
